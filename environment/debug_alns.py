...
print("C", b1.metrics, flush=True)
sol, log = alns_search(b1, ev, dec, seed=1, iterations=3, mode="sorties", j_bound=0.5)
print("D", sol.metrics, log.accepted_moves, flush=True)
